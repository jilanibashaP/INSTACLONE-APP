...
const Form = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch("https://instaclone-backend-fj6o.onrender.com/form", { method: 'post', body: formData }).then((res) => res.json()).then((data) => { console.log(data); }).catch((e) => console.log(e))
        navigate('/fetch')
    }
    return (
        <>
